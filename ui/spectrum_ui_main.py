...
"background: none;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.faq_authors_text.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Developer - Saurabh</p><p>UX/UI Designer and Developer - DIMFLIX </p><p>Logo and Company name- PlayStack </p></body></html>", None))
